          ...
          <div class="boxFilters">
               <div class="filterHead">
                    <div class="d-flex justify-content-between align-items-center">
                         <a href="javascript:void(0)" v-on:click="btnViewFilter()" class="d-flex justify-content-start align-items-center">
                              <img src="/frontend/images/filter.svg" class="imgFilter" />
                              <p>Filtros</p>
                         </a>
                         <div class="boxButtonTransparent">
                              <button v-on:click="clearAll()">Limpiar</button>
                         </div>
                    </div>
               </div>
               <div class="boxViewOptionFilt">
                    ...
                    <div class="boxRowFilter">
                         ...
                         <form action="" class="mt-3">
                              <div class="boxInputSearch relative">
                                   ...
                                   <a href="javascript:void(0)" class="iconSearch" v-on:click="buscarProductos()">
                                        <img src="/frontend/images/search.svg" />
                                   </a>
                    ...
                    <div class="accordion mt-3" id="accordionPanelsStayOpenExample">
                         ...
                         <div class="accordion-item mb-3">
                              ...
                              <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree">
                                   ...
                                   <div class="accordion-body" v-if="doneCategory.id === 1">
